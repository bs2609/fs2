...
public abstract class FS2Constants {
	...
	/** Determines how long the client will wait for a shutdown of all its elements.
	 *  After this delay the VM will be terminated. 10 seconds...
	 */
	...
	/** The name of the directory (within the platform root) where code updates are kept. */
	public static final String CLIENT_UPDATES_SUBDIRECTORY = "updates";
	...
	/** The number of milliseconds between checking for other instances of FS2. */
	public static final int CLIENT_INSTANCE_DETECTION_INTERVAL = 1000;
	...
	/** Properties that should be kept between FS2 relaunches. */
